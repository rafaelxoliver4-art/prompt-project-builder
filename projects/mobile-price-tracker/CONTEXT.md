...
> **Version:** 0.5.5 · **Last updated:** 2026-07-01 · Content decided by the Architect; written by Code.
...
- **⚠️ Digital column nuance (beyond the task's assumption):** the cheapest no-commitment Easy Lite is **R$35** (the 20GB card, which has NO annual option), not ~R$45. So the **Digital matrix column = R$35** (Vivo) — up from the R$30 loyalty price it showed before, correctly reflecting the no-commitment view. (Claro Flex cheapest = R$44,90.)
